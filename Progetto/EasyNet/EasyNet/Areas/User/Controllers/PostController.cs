...
//                return NotFound();
//            }
//            var postFromDbFirst = _unitOfWork.Post.GetFirstOrDefault(u => u.Id == id);
...
//        [ValidateAntiForgeryToken]
//        public IActionResult DeletePost(int id, [Bind("Id")] Post post)
//        {
//            if (id != post.Id)
//            {
//                return NotFound();
//            }
//            var postSpettacoloFromDbFirst = _unitOfWork.Post.GetFirstOrDefault(u => u.Id == id);
