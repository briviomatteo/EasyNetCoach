        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NomeProfilo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    FotoProfilo = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FkUtente = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Posts", x => x.IdPost);
                    table.ForeignKey(
                        name: "FK_Posts_AspNetUsers_FkUtente",
                        column: x => x.FkUtente,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Commentos_AspNetUsers_FkUtente",
                        column: x => x.FkUtente,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_Posts_FkPost",
                table: "AspNetUsers",
                column: "FkPost",
                principalTable: "Posts",
                principalColumn: "IdPost");
